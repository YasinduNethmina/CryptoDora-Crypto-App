...
function Notifictions() {
  return (
    <div className="notification-tab w-60 rounded-xl border-2 border-solid border-sky-500 bg-[#1B2028] text-white shadow-xl">
      <div className="flex  justify-between">
        <h1 className="ml-3 mt-2 text-[#9e9e9e] hover:text-gray-500">
          Notifications
        </h1>
      </div>

      <div className="mx-4 mt-5 cursor-pointer">
        <h1 className="rounded-xl shadow-md transition-all hover:translate-y-1 hover:shadow-2xl">
