...
function ChartLoadingState() {
  return (
    <>
      <div className="mt-5 ml-7 h-full w-11/12 rounded-xl bg-[#1B2028]">
        ...
        <div className="flex items-center justify-between pl-8">
          <div className="w-1/3 justify-start">
            ...
            <h1 className="ml-1 text-xl font-semibold text-white">99999.99</h1>
          </div>
        ...
        {/* Chart */}
        <div className="mt-20 pb-40 text-center">
          <div role="status">
            <svg
