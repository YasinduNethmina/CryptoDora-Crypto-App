...
function NewsCard01({ title, img, date, description, source }) {
  ...
  return (
    <>
      <div className="news-card m-4 w-full rounded-sm bg-[#1B2028] dark:bg-white dark:shadow-lg">
        <div className="flex">
          <div className="m-4 w-2/3">
            ...
            >
              {
                <h1 className="news-card-title text-md font-semibold text-white hover:underline hover:underline-offset-4 dark:text-black">
                  {String(title).slice(0, 50)}...
                </h1>
              }
            </Link>
            <p className="news-card-description mt-2 text-xs text-[#9E9E9E] dark:text-[#7e818c]">
        ...
        <div className="news-card-footer relative bottom-4 mx-4 flex items-center justify-between text-xs text-[#9E9E9E] dark:font-semibold dark:text-[#00cccb]">
